...
<div class="col-xs-9" style="float: left; width: 80%;">
	<h1 class="text-uppercase">Продажи</h1>
		<div class="table-responsive">
			<table class="table table-bordered">
				<thead>
					<tr>
						<th style="text-transform: none;">#</th>
						<th style="text-transform: none;">Покупатель</th>
				...
				<tbody>
					...
					<tr>
						...
						<th style="text-transform: none;">
							<?php
								echo '<a href="user?id='.$order['buyerId'].'">';
									echo $order['username'];?>
								</a>
						</th>
						<th style="text-transform: none;">
						...
						<th style="text-transform: none;"><?php
						...
						?></th>
						<th style="text-transform: none;"><?php echo $order['date'];?></th>
						<th>
							<a href="changeOrder?id=<?php echo $order['idOrder'];?>">
