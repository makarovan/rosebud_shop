...
--
-- Хост: 127.0.0.1
-- Время создания: Май 31 2022 г., 16:25
...
(2, 3, 4, 1, 1, 1, 1, 0, 0, '2022-05-28 21:00:00'),
...
(32, 10, 2, 18, 1, 0, 0, 0, 0, '2022-05-29 10:12:53'),
(33, 13, 4, 2, 1, 1, 0, 0, 0, '2022-05-28 21:00:00');
...
INSERT INTO `userrole` (`rolename`, `idRole`) VALUES
('admin', 1),
('user', 2),
('buyer+seller', 3);
...
(1, 1, 'admin@rosebud.ee', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', '', 0, '', 'admin', ''),
(2, 2, 'user@rosebud.ee', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', 'tallinn, narva mnt 23-11', 235656545, 'alla nikonova', 'user', 'продаю милые штучки'),
(3, 2, 'user2@rosebud.ee', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', 'narva, tallinna mnt 23-22', 232323, 'nadja', 'nadja97', ''),
(4, 2, 'marina@marina.ee', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', 'johvi, kutse 13', 3030, 'kutse marina', 'marina', 'продаю штуки'),
(16, 2, 'password@password.password', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', '232121212', 0, 'asasa', 'password', '12122'),
(17, 2, 'estelle@est.com', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', 'e', 0, 'e', 'estelle', ''),
(18, 2, 'andrei.smirnov@mail.ru', '$2y$12$mjv/GPng4oQFohhkPl8RPucmgRDFVs/UCVP02US.r92ra09kK4d7u', 'tallinna mantee 27-42', 5656454, 'Andrei S', 'Andrei', '');
...
--
ALTER TABLE `products`
  MODIFY `idProduct` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
